...
async function main() {
  ...
  await prisma.siteSettings.upsert({
    ...
    create: {
      ...
      mapEmbedUrl:
        "https://www.google.com/maps?q=Hatton+Sri+Lanka&output=embed",
  ...
  // ---------- Members ----------
  // Member has no natural unique key, so we clear and re-create.
  // Safe in dev; in prod you'd guard this behind an env flag.
  ...
  const boardMembers = [
    {
      ...
      nameTa: "ஏ. பி. பெரேரா",
      nameSi: "ඒ. බී. පෙරේරා",
      designationEn: "Chairperson",
      designationTa: "தலைவர்",
      designationSi: "සභාපති",
    },
    {
      nameEn: "S. Kumar",
      nameTa: "எஸ். குமார்",
      nameSi: "එස්. කුමාර්",
      designationEn: "Vice Chairperson",
      designationTa: "துணைத் தலைவர்",
      designationSi: "උප සභාපති",
    },
    {
      nameEn: "N. Silva",
      nameTa: "என். சில்வா",
      ...
      designationTa: "பொருளாளர்",
      designationSi: "භාණ්ඩාගාරික",
    },
  ];
  ...
  const committeeMembers = [
    {
      nameEn: "R. Fernando",
      nameTa: "ஆர். பெர்னாண்டோ",
      nameSi: "ආර්. ප්‍රනාන්දු",
      designationEn: "Secretary",
      designationTa: "செயலாளர்",
      designationSi: "ලේකම්",
    },
    {
      nameEn: "T. Raj",
      nameTa: "டி. ராஜ்",
      nameSi: "ටී. රාජ්",
      designationEn: "Committee Member",
      designationTa: "குழு உறுப்பினர்",
      designationSi: "කමිටු සාමාජික",
    },
  ];
  ...
  // ---------- Content items ----------
  // slug is @unique, so upsert is the safe choice here.
  await prisma.contentItem.upsert({
    where: { slug: "hatton-primary-roof" },
    update: {},
    create: {
      ...
      summaryEn:
        "120 children now learn in a dry classroom for the first time in six years.",
      descriptionEn:
        "Full details of the roof renovation project at Hatton Primary School, funded entirely by local donors and completed in March.",
      published: true,
      featured: true,
    },
  });
  ...
  await prisma.contentItem.upsert({
    where: { slug: "estate-school-scholarships-2026" },
    update: {},
    create: {
      ...
      descriptionEn:
        "We are raising funds to support 18 additional students from estate schools with scholarships covering fees, materials and transport.",
  ...
  await prisma.contentItem.upsert({
    where: { slug: "community-library-maskeliya-opening" },
    update: {},
    create: {
      ...
      summaryEn:
        "A reading space built with three estate communities, now open six days a week.",
      descriptionEn:
        "A reading space built with three estate communities, now open six days a week.",
      published: true,
    },
